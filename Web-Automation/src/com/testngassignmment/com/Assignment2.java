...
private static void modifyUser()
{
	try
	{
	oBrowser.findElement(By.xpath("//span[@class='approveTTIcon editing']")).click();
	Thread.sleep(2000);
	oBrowser.findElement(By.xpath("//td[@class='userNameCell first']")).click();
	Thread.sleep(2000);
	oBrowser.findElement(By.xpath("//*[@name='firstName']")).clear();
	oBrowser.findElement(By.xpath("//*[@name='firstName']")).sendKeys("USERDEMO");
	Thread.sleep(2000);
	oBrowser.findElement(By.xpath("//*[@name='lastName']")).clear();
	oBrowser.findElement(By.xpath("//*[@name='lastName']")).sendKeys("123");
	Thread.sleep(2000);
	oBrowser.findElement(By.xpath("//*[@id='userDataLightBox_commitBtn']")).click();
	Thread.sleep(2000);
	}catch (Exception e)
