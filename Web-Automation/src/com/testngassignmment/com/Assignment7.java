...
public class Assignment7
{
	...
	private static void createTask()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@class='item createNewTask ellipsis']")).click();
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id=\'ext-gen150\']")).click();
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id=\'ext-gen284\']")).click();
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id=\'ext-gen165\']/td[2]")).click();
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id=\'ext-gen312\']")).click();
			Thread.sleep(2000);
	...
	private static void deleteTask()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("/html/body/div[12]/div[2]/div[1]/div[3]/div/div/div[4]")).click();
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//div[@id='deleteTaskPopup_deleteConfirm_submitBtn']")).click();
			Thread.sleep(2000);
		}catch (Exception e)
		{
			e.printStackTrace();
